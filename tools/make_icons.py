...
def write_icons_js() -> None:
    """Bundle every icon as a one-line string in src/utils/icons.js with an
    ES-module `icon(name, className)` helper. Imported by src/main.js, so the
    helper is available the moment anything renders — zero async, no fetch,
    no shadow DOM."""
    lines = [
        "/* src/utils/icons.js — auto-generated by tools/make_icons.py. Do not edit manually. */",
        "",
    ...
    js = "\n".join(lines)
    js_path = ROOT / "src" / "utils" / "icons.js"
