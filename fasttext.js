...
// Emscripten's MODULARIZE factory is async in current versions and fully
// initializes the runtime (including post-run) before the returned promise
// resolves. Awaiting it is therefore the correct way to get a ready module,
// and addOnPostRun callbacks fire immediately — the post-run event they
// used to wait for has already happened by the time the module is usable.
